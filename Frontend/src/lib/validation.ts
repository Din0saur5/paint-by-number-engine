import { ACCEPTED_TYPES, MAX_COLORS, MAX_UPLOAD_BYTES, MAX_WIDTH, MIN_COLORS, MIN_WIDTH } from './constants'
...
export const validateForm = (numColors: number, maxWidth: number): ValidationIssue | null => {
